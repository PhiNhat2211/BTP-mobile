...
{
    public class CBurlapOutput : AbstractBurlapOutput
    {
        #region CLASS_FIELDS
        /// <summary>
        /// the output stream
        ...
        */
        ...
        #region CONSTRUCTORS
        /// <summary>
        /// Initializes a new instance of the CBurlapOutput class
        /// </summary>
        ...
        /// </param>
        public override void WriteFault(System.String code, System.String message, object  detail)
        {
            Print("<fault>");
            WriteString("code");
            WriteString(code);
        ...
        {
            //Todo: Parameter wurde ge?dert in DateTime!
