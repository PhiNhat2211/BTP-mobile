...
namespace TCPComm.EEStruct
{
    ...
    [Serializable]
    public class sTrayUI_sRTG_PDS_Periodic_Payload : EEParentClass
    {
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_sRTG_CPS_Alignment_Payload : EEParentClass
    {
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_sRTG_PDS_PickDrop_Payload : EEParentClass
    {
        public UInt32 m_dwTime;                // 시간
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_sRTG_PDS_PickDropConfirm_Payload : EEParentClass
    {
        public sTrayUI_sRTG_PDS_PickDrop_Payload m_sPickDrop; //PickDrop정보
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_sRTG_PDS_RFID_Payload : EEParentClass
    {
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_ManualReadyRTG : EEParentClass
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = EEv2StringMax.EEV2_STRING_MAX_JOB_KEY)]
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_RTGMarrying : EEParentClass
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = EEv2StringMax.EEV2_STRING_MAX_MACHINE_ID)]
        public String WorkingMachineID;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = EEv2StringMax.EEV2_STRING_MAX_MACHINE_TP)]
    ...
    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class sTrayUI_sRTG_OTR_ManualBlockInOut
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = EEv2StringMax.EEV2_STRING_MAX_JOB_KEY)]
        public String m_JobKey;
        public Byte m_btInOut; //     1byte     1 이면 In    (  0 이면 Out : Default )
        //----------------------------- Tag정보.
        public sTrayUI_sRTG_PDS_RFID_Payload m_OTR_RFIDTagInfo;    //없으면 0값으로
    }

    [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto, Pack = 1)]
    [Serializable]
    public class EEv3JobOrderList_RTG : EEParentClass
    {
