...
{
    public class CBurlapInput : AbstractBurlapInput
    {
        #region Constants
        ...
        /// <summary>
        /// Initializes a new instance of the CBurlapInput class
        /// </summary>
        ...
        protected internal virtual long ParseDate(System.Globalization.Calendar calendar)
        {
            ...
            m_intPeek = ch;
            //TODO: wenn es tut die Methode mit Parameter calender ?erarbeiten, calender entfernen.
        ...
        /// </code>
        /// </summary>
        /// <exception>cref="CBurlapException"</exception>
        ...
        /// </code>
        /// </summary>
        /// <exception>cref="ExpectedTag"</exception>
        /// <returns>integer value</returns>
