...
namespace LogExtensions
{
    ...
    public static class LogExtensions
    {
        ...
        {
            //return _dictionary.GetOrAdd(objectName, LoggingExtensions.Core.Log.GetLoggerFor);
            ILog retValue = null;
            if (_dictionary.TryGetValue(objectName, out retValue))
                return retValue;
            else
                return LoggingExtensions.Core.Log.GetLoggerFor(objectName);
        }
    }
}