...
namespace burlapcsharp.client
{
    ...
    /// </summary>
    public class CBurlapProxyStandardImpl : RealProxy, IRemotingTypeInfo, IBurlapProxyStandard
    {
        #region CLASS_FIELDS
        /// <summary>
        ...
        #region CONSTRUCTORS
        /// <summary>
        /// Initializes a new instance of the CBurlapProxyStandardImpl class
        /// </summary>
